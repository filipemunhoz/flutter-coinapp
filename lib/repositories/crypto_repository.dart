...
import 'package:coinapp/models/coin_model.dart';
import 'package:coinapp/repositories/base_crypto_repository.dart';
...
class CryptoRepository extends BaseCryptoRepository{
  ...
  Future<List<Coin>> getTopCoins({int page}) async {
    ...
    String requestUrl = '$_baseUrl/data/top/totalvolfull?limit=$perPage&tsym=USD&page=$page';
